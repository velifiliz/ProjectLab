                                ...
                                n.using &&
                                    (h = function (t) {
                                        ...
                                        u > g && g > r(e + i) && (l.horizontal = "center"),
                                            ...
                                            (l.important = a(r(e), r(i)) > a(r(s), r(o)) ? "horizontal" : "vertical"),
                        ...
                        left: function (t, e) {
                            ...
                            e.collisionWidth > o
                                ? l > 0 && 0 >= h
                                    ...
                                    : (t.left = h > 0 && 0 >= l ? n : l > h ? n + o - e.collisionWidth : n)
                                : l > 0
                                ? (t.left += l)
                                : h > 0
                                ? (t.left -= h)
                        ...
                        top: function (t, e) {
                            ...
                            e.collisionHeight > o
                                ? l > 0 && 0 >= h
                                    ...
                                    : (t.top = h > 0 && 0 >= l ? n : l > h ? n + o - e.collisionHeight : n)
                                : l > 0
                                ? (t.top += l)
                                : h > 0
                                ? (t.top -= h)
                    ...
                    flip: {
                        ...
                        top: function (t, e) {
                            ...
                            0 > c
                                ...
                                : u > 0 && ((i = t.top - e.collisionPosition.marginTop + p + f + g - l), (i > 0 || u > r(i)) && (t.top += p + f + g));
                        },
                    },
                    flipfit: {
                        left: function () {
                        ...
                        for (I += "<tr>", E = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(A) + "</td>" : "", w = 0; 7 > w; w++)
                            (W = m ? m.apply(t.input ? t.input[0] : null, [A]) : [!0, ""]),
                                ...
                                (E +=
                                    ...
                                    (F && !_ ? "" : " " + W[1] + (A.getTime() === G.getTime() ? " " + this._currentClass : "") + (A.getTime() === Y.getTime() ? " ui-datepicker-today" : "")) +
                                    "'" +
